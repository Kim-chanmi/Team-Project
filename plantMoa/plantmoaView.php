                ...
                <div class="details-title-fixed">
                    <ul class="nav nav-tabs" id="detailsTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="water-tab"
                                data-toggle="tab" href="#water" role="tab" aria-controls="water"
                                aria-selected="true">물
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="light-tab" data-toggle="tab"
                                href="#light" role="tab" aria-controls="light" aria-selected="false">빛
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="humidity-tab" data-toggle="tab"
                                href="#humidity" role="tab" aria-controls="humidity" aria-selected="false">습도
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="temperature-tab"
                                data-toggle="tab" href="#temperature" role="tab" aria-controls="temperature"
                                aria-selected="false">관리
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="tabInfo active">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc2">
                                봄과 여름에는 물을 자주 주는 것이 좋습니다. 흙을 항상 촉촉하게 유지해 주시고, 햇빛이잘드는 공간에 놔둬 주세요. 흙의 마름을 확인 하시고 물을 주시고, 환기를 잘 시켜 주어야 과습과 병충해의 피해를 막을 수 있습니다.
                            </p>
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc2">
                                거실 창측 (실내깊이 150~300cm), 발코니 내측 (실내깊이 50~150cm), 발코니 창측 (실내깊이 0~50cm)정도에서 배치하여 키우는 것을 추천드립니다.
                ...
                <div class="plantmoaInfo__inner2">
                    <div class="tabInfo">
                        ...
                        <div class="plantmo__Water">
                            ...
                            <p class="plantInfo__desc2">
                                습도가 낮을 경우에는 몬스테라의 잎이 갈색 반점이 생기는 경우가 있습니다. 이때 공중분무와 가습기를 틀어 공중습도를 높입니다. 갈색 반점이 생겨난 잎은 잘라내도록 합니다.<br>
